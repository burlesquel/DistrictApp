...
const { pending, data, error } = await useAsyncData(`user_${user_id}`, async () => firestore.getUserById(user_id), { server: false, lazy: false })
            ...
            <div class="mb-5 grid grid-cols-1 gap-5 lg:grid-cols-3 xl:grid-cols-4">
                <div class="panel">
                    <div class="mb-5 flex items-center justify-between">
                        ...
                        <NuxtLink to="/users/user-account-settings"
                    ...
                    <div class="mb-5">
                        <div class="flex flex-col items-center justify-center">
                            <img :src="store.user.photoURL" alt="" class="mb-5 h-24 w-24 rounded-full object-cover" />
                            <p class="text-xl font-semibold text-primary">{{ data?.displayName }}</p>
                        </div>
                        <ul class="m-auto mt-5 flex max-w-[160px] flex-col space-y-4 font-semibold text-white-dark">
                            ...
                            <li>
                                <a href="javascript:;" class="flex items-center gap-2">
                                    ...
                                    <span class="truncate text-primary">{{ "asddasd" }}</span></a>
                            </li>
                            <li class="flex items-center gap-2">
                                <icon-phone />
