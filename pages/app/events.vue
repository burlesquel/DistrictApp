                        ...
                        <perfect-scrollbar :options="{
                            ...
                            <div class="space-y-1">
                                ...
                                <button type="button"
                                    class="flex h-10 w-full items-center justify-between rounded-md p-2 font-medium hover:bg-white-dark/10 hover:text-primary dark:hover:bg-[#181F32] dark:hover:text-primary"
                                    :class="{
                                        'bg-gray-100 text-primary dark:bg-[#181F32] dark:text-primary': !isEdit && selectedTab === 'draft',
                                ...
                                <button type="button"
                                    class="flex h-10 w-full items-center justify-between rounded-md p-2 font-medium hover:bg-white-dark/10 hover:text-primary dark:hover:bg-[#181F32] dark:hover:text-primary"
                                    :class="{
                                        'bg-gray-100 text-primary dark:bg-[#181F32] dark:text-primary': !isEdit && selectedTab === 'trash',
                                        ...
                                        <disclosure-panel as="ul" :unmount="false" class="mt-1 space-y-1">
                                            <li>
                                                <button type="button"
                                                    class="flex h-10 w-full items-center rounded-md p-2 font-medium hover:bg-white-dark/10 hover:text-primary dark:hover:bg-[#181F32] dark:hover:text-primary"
                                                    :class="{
                                                        'bg-gray-100 text-primary dark:bg-[#181F32] dark:text-primary': !isEdit && selectedTab === 'archive',
                                            ...
                                            <li>
                                                <button type="button"
                                                    class="flex h-10 w-full items-center rounded-md p-2 font-medium hover:bg-white-dark/10 hover:text-primary dark:hover:bg-[#181F32] dark:hover:text-primary"
                                                    :class="{
                                                        'bg-gray-100 text-primary dark:bg-[#181F32] dark:text-primary': !isEdit && selectedTab === 'important',
                ...
                <div v-show="!selectedMail && !isEdit" class="flex h-full flex-col">
                    <div class="flex flex-wrap-reverse items-center justify-between gap-4 p-4">
                        <div class="flex w-full items-center sm:w-auto">
                            ...
                            <div class="ltr:mr-4 rtl:ml-4">
                                <client-only>
                                    <button type="button" v-tippy:refresh class="flex items-center hover:text-primary"
                                        @click="refreshMails()">
                                        <icon-refresh />
                                    </button>
                            ...
                            <template v-if="selectedTab != 'trash'">
                                <ul class="flex grow items-center gap-4 sm:flex-none ltr:sm:mr-4 rtl:sm:ml-4">
                                    <li>
                                        <div>
                                            <client-only>
                                                <button type="button" v-tippy:archive
                                                    class="flex items-center hover:text-primary" @click="setArchive">
                                                    <icon-archive />
                                                </button>
                                    ...
                                    <li>
                                        <div @click="setSpam">
                                            <client-only>
                                                <button type="button" v-tippy:spam
                                                        ...
                                                        <ul @click="close()">
                                                            <li>
                                                                <a href="javascript:;" @click="setGroup('personal')">
                                                                    <div
                                                                        class="h-2 w-2 shrink-0 rounded-full bg-primary ltr:mr-3 rtl:ml-3">
                                                                    </div>
                                                                    Personal
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="javascript:;" @click="setGroup('work')">
                                                                    <div
                                                                        class="h-2 w-2 shrink-0 rounded-full bg-warning ltr:mr-3 rtl:ml-3">
                                                                    </div>
                                                                    Work
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="javascript:;" @click="setGroup('social')">
                                                                    <div
                                                                        class="h-2 w-2 shrink-0 rounded-full bg-success ltr:mr-3 rtl:ml-3">
                                                                    </div>
                                                                    Social
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="javascript:;" @click="setGroup('private')">
                                                                    <div
                                                                        class="h-2 w-2 shrink-0 rounded-full bg-danger ltr:mr-3 rtl:ml-3">
                                                                    </div>
                                                                    Private
                                                                </a>
                                                            </li>
                            ...
                            <template v-if="selectedTab == 'trash'">
                                <ul class="flex flex-1 items-center gap-4 sm:flex-none ltr:sm:mr-3 rtl:sm:ml-4">
                                    <li>
                                        <div>
                                            <client-only>
                                                <button type="button" v-tippy:delete class="block hover:text-primary"
                                    ...
                                    <li>
                                        <div>
                                            <client-only>
                                                <button type="button" v-tippy:restore class="block hover:text-primary"
