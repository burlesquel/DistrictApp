                                            ...
                                            <li>
                                                <button type="button" class="w-full hover:text-primary"
                                                    ...
                                                    <img class="h-5 w-5 rounded-full object-cover"
                                                        :src="`/app/images/flags/${item.code.toUpperCase()}.svg`" alt="" />
                                    ...
                                    <ul class="top-11 w-[300px] !py-0 text-xs text-dark dark:text-white-dark sm:w-[375px]">
                                        <li class="mb-5">
                                            <div class="relative overflow-hidden rounded-t-md !p-5 text-white">
                                                <div
                                                    class="absolute inset-0 h-full w-full bg-[url('/app/images/menu-heade.jpg')] bg-cover bg-center bg-no-repeat">
                                                </div>
                                                    ...
                                                    <div class="grid place-content-center rounded">
                                                        <div class="relative h-12 w-12">
                                                            <img class="h-12 w-12 rounded-full object-cover"
                                                                :src="`/app/images/${notification.profile}`" alt="" />
                                                            <span
                            ...
                            <Popper :placement="'bottom-start'" offsetDistance="8" class="!block">
                                ...
                                <template #content="{ close }">
                                    <ul
                                        ...
                                        <li>
                                            <NuxtLink to="/app" class="dark:hover:text-white" @click="close()">
