        ...
        <nav
            ...
            <div class="h-full bg-white dark:bg-[#0e1726]">
                <div class="flex items-center justify-between px-4 py-3">
                    <NuxtLink to="/" class="main-logo flex flex-col justify-center items-center">
                        <img class="ml-[5px] w-1/2 flex-none" src="/front/images/logogo.png" alt="" />
                        <span class="align-middle text-2xl font-semibold ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light lg:inline text-orange-500">DISTRICT<span class="text-black">APP</span> </span>
                    </NuxtLink>
                    <a href="javascript:;"
